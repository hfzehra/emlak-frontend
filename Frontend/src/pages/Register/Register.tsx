...
export const Register = () => {
  ...
  const onSubmit = async (data: RegisterForm) => {
    // Backend RegisterCommand: companyName, companyEmail (şirket emaili), email (kullanıcı emaili)
    // Sade formda şirket emaili = kullanıcı emaili, firstName/lastName boş bırakılamaz
    // Bunları email'den türetelim
    const payload = {
